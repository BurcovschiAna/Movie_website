<div>
   <h1>MovieMatrix Project</h1>
    ...
    <ul>
        <li>Bootstrap Icons for icon library</li>
        <li>Google Material Icons for design system</li>
        <li>jQuery & jQuery UI for DOM manipulation</li>
        <li>EmailJS for email service</li>
    </ul>
    <h2>Contact</h2>
    ...
    <ol>
        ...
        <li>Navigate to the root directory of the MovieMatrix project using the <code>cd</code> command.</li>
        <li>Run the following command to install Live Server globally:
            <pre><code>npm install -g live-server</code></pre>
        </li>
        <li>Once installed, start the Live Server by running:
            <pre><code>live-server</code></pre>
        </li>
        <li>Your default web browser will open, displaying the MovieMatrix application.</li>
    </ol>
</div>